        ...
        <div class="form-group__container">
          ...
          <div class=" checkbox-group">
            ...
            <label class="checkbox-container checkbox-container--post">Other
              <input v-model="form.other" type="checkbox">
              <span class="checkbox-checkmark" />
            </label>
          </div>
          
          <div class="form-group__container mt-2" v-if="form.other">
              <div class="">
                <input v-model="form.other_skill" class="form-group__input-text" placeholder="Type other">
              </div>
          </div>
        </div>
