...
declare interface ExtendedIconifyIcon extends IconifyIconData, APIIconAttributes {}
...
declare const IconifyIcon: {
     ...
     * @param context
     */
    render(createElement: typeof _Vue.prototype.$createElement, context: any): VNode;
    /**
     * Add icon to storage that can later be used by name, for example: <iconify-icon icon="home" />
     */
    addIcon: (name: string, data: IconifyIconData) => void;
    /**
 ...
 * Icon.
 */
export declare interface IconifyIconData extends IconifyOptional {
