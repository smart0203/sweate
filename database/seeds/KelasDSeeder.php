...
class KelasDSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $skills = [
            'Frontend Engineer' => [
                'HTML', 'HTML5', 'Cascading Style Sheets (CSS)', 'JavaScript', 'JSON', 'XML', 'Front-end Development', 'Front-end Coding', 'Front-end Design', 'Front-end Engineering', 'Bootstrap', 'React', 'Vue.js', 'Semantic UI', 'Angular', 'Foundation', 'Other'
            ],
            'Backend Engineer' => [
                'PHP', 'SQL', 'Microsoft SQL Server', 'MySQL', 'Java', 'C++', 'C', 'Node.js', 'Back-end Web Development', 'C#', 'MongoDB', 'Laravel', 'Django', 'Ruby on Rails', 'CakePHP', 'Express.Js', 'Spring Boot', 'Other'
            ],
            'UI/UX Designer' => [
                'User Experience (UX)', 'User Interface Design', 'Graphic Design', 'User Experience Design (UED)', 'User Interface Prototyping', 'User Interface Programming', 'User Experience Testing', 'UX Research', 'Other'
            ],
            'Data Expert' => [
                'Machine Learning', 'Requirements Analysis', 'Data Analysis', 'Data Mining', 'Data Modeling', 'Big Data', 'Data Visualization', 'Data Science', 'Data Warehousing', 'Python', 'Matlab', 'Data Classification', 'Exploratory Data Analysis', 'Data Engineering', 'SPARQL', 'Web Crawling', 'Protege', 'Other'
            ],
            'Sales & Marketing' => [
                'Digital Marketing', 'Social Media Marketing', 'Lead Generation', 'Strategy', 'Copywriting', 'Analysis', 'Graphic Design', 'Ads', 'Email Campaign', 'Sales Funnel', 'ECommerce', 'PR', 'CRM', 'Other'
            ],
            'Other' => ['Digital Marketing', 'Social Media Marketing', 'Lead Generation', 'Strategy', 'Copywriting', 'Analysis', 'Graphic Design', 'Ads', 'Email Campaign', 'Sales Funnel', 'ECommerce', 'PR', 'CRM', 'Other'],
        ];
        ...
        for ($i = 10; $i < count($list_kelas_d) + 10; $i++) {
            ...
            $users[] = [
                ...
                'role' => 'Student', //Student is Looker, Teacher is Lister
                'expertise' => $expertise,
