  ...
  <div class="post__container mx-auto">
    ...
    <form @submit.prevent="``">
      <div class="">
        ...
        <div class="form-group__container">
          ...
          <div class="checkbox-group">
            ...
            <label class="checkbox-container checkbox-container--post">Sales & Marketing
              <input v-model="form.sales_marketing" type="checkbox">
              <span class="checkbox-checkmark" />
            </label>
            <label class="checkbox-container checkbox-container--post">Other
              <input v-model="form.otherShow" type="checkbox">
              <span class="checkbox-checkmark" />
            </label>
          </div>

          <div class="form-group__container mt-2" v-if="form.otherShow">
              <div class="">
                <input v-model="form.other" class="form-group__input-text" placeholder="Type other">
              </div>
          </div>
            ...
            <template v-slot:body>
              <div>
                ...
                <div class="">
                  ...
                  <p class="info__p" style="text-align: right;">
      ...
      <div class="form-group__container">
        ...
        <div class=" checkbox-group">
          <label class="checkbox-container checkbox-container--post">Equity
            <input v-model="form.equity" type="checkbox" value="1">
            <span class="checkbox-checkmark" />
          </label>
        </div>
        <div class=" checkbox-group mt-2">
          <label class="checkbox-container checkbox-container--post">Rev Share
            <input v-model="form.rev_share" type="checkbox" value="1">
            <span class="checkbox-checkmark" />
          </label>
        </div>
      </div>
