<template>
  <div class="forgot-password__container">
    ...
    <p class="forgot-password__p">
      Don’t worry! Resetting your password is easy. Just type in this email field below that you registered on Sweatequity.
    </p>
    ...
    <form class="forgot-password__form--container" @submit.prevent="send" @keydown="form.onKeydown($event)">
      ...
      <div>
        ...
        <p class="forgot-password__further-information">
          For further information. Please kindly reach out to <a href="mailto:info@sweate.me">info@sweate.me</a>
        </p>
      </div>
