    ...
    <div class="slide slide-1__background">
      ...
      <div class="slide-1__container">
        <div class="slide-1__image-container moveInTop duration--2">
          ...
          <img v-else class="slide-1__image" src="/images/team-building-activities-banner.png" alt="">
        </div>
...
export default {
  ...
  metaInfo () {
    return {
      title: 'Home',
      meta: [
        { name: 'description', content: 'Sweatequity: Freelancer Platform for Students. Expand your career by doing projects.' }
      ]
    }
  },
  ...
  methods: {
    appendNavBg () {
      ...
      sheet.innerHTML = '.nav-base { background: #fff } .desktop-nav { background: #fff }'
