...
class ProjectLecturerController extends Controller
{
        ...
        if ($user->role === 'Lecturer') {
            ...
            $project = Project::firstOrCreate(
                ...
                [
                    ...
                    'sales_marketing' => $request->post('sales_marketing'),
                    'other' => $request->post('otherShow'),
                    'other_skill' => $request->post('other'),
                    'equity' => $request->post('equity') ? $request->post('equity') : false,
                    'rev_share' => $request->post('rev_share') ?  $request->post('rev_share') : false,
    ...
    public function updateProject(Request $request, Project $project)
    {
        ...
        $project->equity = $request->post('equity');
        ...
        $project->sales_marketing = $request->post('sales_marketing');
        $project->other = $request->post('other');
        $project->other_skill = $request->post('other_skill');
        $project->status = $projectStatus;
        $project->rev_share = $request->post('rev_share');
